...
def create_symlinks(files_list, links_list, src, trg):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--src-lang", type=str, help="Source language extension")
    parser.add_argument("--trg-lang", type=str, help="Target language extension")
    ...
    create_symlinks(args.files, args.links, args.src_lang, args.trg_lang)
